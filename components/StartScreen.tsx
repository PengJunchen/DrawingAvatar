    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          Create Amazing <span className="text-blue-400">Avatars</span> with AI
        </h1>
        <p className="max-w-2xl text-lg text-gray-400 md:text-xl">
          Generate unique, creative avatars from your photos using advanced AI technology. Upload an image and let the magic happen.
        </p>
        ...
        <div className="mt-16 w-full">
            <div className="max-w-md mx-auto">
                <div className="bg-black/20 p-8 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <h3 className="text-2xl font-bold text-gray-100">Generate Creative Avatar</h3>
                    <p className="mt-4 text-gray-400">Transform your photos into stunning avatars with our powerful AI generator. Get unique results every time.</p>
                </div>
            </div>
        </div>
